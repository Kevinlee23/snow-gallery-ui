<template>
  <PhotosFilterUI type="ALBUM" :photos="photos" :total="total" />
</template>
...
onMounted(async () => {
  const res: Response<{ list: Photo[]; total: number }> = await request.post('/gallery/album/page-photos', { _id: filterValue })
